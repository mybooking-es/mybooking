 ...
 *
 */
define( 'MYBOOKING_FONT_SELECTOR_VERSION', '1.0.0' );

if ( ! function_exists( 'mybooking_font_selector_get_standard_fonts' ) ) {
	/**
	 * List of standard fonts
	 */
	function mybooking_font_selector_get_standard_fonts() {
...
if ( ! function_exists( 'mybooking_font_selector_get_google_fonts_array' ) ) {
	/**
	 * List of All Google fonts
	 */
	function mybooking_font_selector_get_google_fonts_array() {
...
if ( ! function_exists( 'mybooking_font_selector_enqueue_google_font' ) ) {
	/**
	 * Enqueues a Google Font
	 *
	 * @since 1.1.38
	 */
	function mybooking_font_selector_enqueue_google_font( $font ) {

...
if (!class_exists('MyBookingCustomizer')) {
  ...
  class MyBookingCustomizer
  {
        ...
        switch ($header_bg) {
          case '0':
            ...
            if (!empty($header_image_bg)) {
              ...
              if (!empty($image_id)) {
                $header_image_bg = wp_get_attachment_image(
                  $image_id,
                  'full',
                  false,
                  ['src', 'class' => "home-header_background home-header_background-img", 'alt']
                );
              }
            }
          ...
          case '2':
            ...
            if (is_array($header_carrousel_bg) && !empty($header_carrousel_bg)) {
              foreach ($header_carrousel_bg as $carrousel_img) {
                $img_carrousel = wp_get_attachment_image(
                  $carrousel_img,
                  'full',
                  false,
                  ['src', 'alt']
    ...
    private function customize_company($wp_customize)
    {
      ...
      $wp_customize->add_setting(
        'mybooking_company_google_maps_code',
        array(
          'default' => '',
          'transport' => 'refresh',
    ...
    private function customize_navbar_section($wp_customize)
    {
      ...
      $wp_customize->add_control(
        'mybooking_home_navbar_integrated',
        array(
      ...
      // Columns
      $wp_customize->add_setting(
        'mybooking_global_navigation_layout',
        array(
          'default' => '0',
          'transport' => 'refresh',
    ...
    private function customize_header_section($wp_customize)
    {
      ...
      // Setting
      $wp_customize->add_setting('mybooking_header_bg_color', array(
        'default' => '#FFF',
        'transport' => 'refresh',
        'sanitize_callback' => array($this, 'slug_sanitize_rgba')
      ));
      ...
      $wp_customize->add_control(new MyBookingCustomizer_Alpha_Color_Control(
        $wp_customize,
        'header_desktop_bg_color',
        array(
          'label' => _x('Header background color', 'customizer_header', 'mybooking'),
          'section' => 'mybooking_theme_header_options',
          'settings' => 'mybooking_header_bg_color'
        )
      ));
    ...
    private function customize_footer_section($wp_customize)
    {
      ...
      $wp_customize->add_section(
        ...
        array(
          ...
          'capability'  => 'edit_theme_options',
          'description' => _x('Controls footer layout, background and link colors.', 'customizer_footer', 'mybooking'),
          'priority'    => 56,
          'panel'        => 'mybooking_settings_panel',
        )
      );
      ...
      // Setting
      $wp_customize->add_setting(
        'mybooking_global_footer_layout',
        array(
          'default' => '1',
          'transport' => 'refresh',
          'sanitize_callback' => array($this, 'slug_sanitize_radio')
    ...
    private function customize_selector_section($wp_customize)
    {
      ...
      // -- Home Form background mobile

      // Setting
      $wp_customize->add_setting('mybooking_home_selector_mobile_background', array(
        'default' => '#f5f5f5',
        'transport' => 'refresh',
        'sanitize_callback' => array($this, 'slug_sanitize_rgba')
      ));
      ...
      $wp_customize->add_control(new MyBookingCustomizer_Alpha_Color_Control(
        ...
        array(
          ...
          'section' => 'mybooking_theme_selector_options',
          'settings' => 'mybooking_home_selector_mobile_background'
        )
      ));

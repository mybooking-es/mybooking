    ...
    <div class="col">
      ...
      <ul>
        <li>
          ...
          <?php $company_name = MyBookingCustomizer::getInstance()->get_theme_option("company_info_name");
            if ($company_name !== '') { ?>
        ...
        <li>
          ...
          <?php $company_id = MyBookingCustomizer::getInstance()->get_theme_option("company_info_nif");
            if ($company_id !== '') { ?>
  ...
  <?php } else { ?>
    ...
    <div class="col">
      <ul class="social-links d-flex justify-content-center justify-content-md-end">
        ...
        <?php $company_youtube = MyBookingCustomizer::getInstance()->get_theme_option("company_info_youtube_url");
          if ($company_youtube !== '') { ?>
          <li class="social__item">

...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
  <div class="entry-content">
    <div class="row">
      <div class="col-md-6 vehicle_image">

        <?php echo get_the_post_thumbnail( $post->ID, 'large' ); ?>


      </div>
      <div class="col-md-6 vehicle_info">
        ...
        <h2 class="entry-title vehicle_name"><?php the_title() ?></h2>
        ...
        <p>
          <a data-toggle="collapse" href="#vehicle_details" aria-expanded="false" aria-controls="vehicle_details">
            <i class="fas fa-info-circle"></i> Detalles
          </a>
        </p>
        <div class="collapse" id="vehicle_details">

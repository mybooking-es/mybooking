  ...
  <div class="row">
      ...
      <div class="activity-view-card">
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          ...
          <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
            ...
            <span class="sr-only">
              <? echo _x('Previous', 'activity_detail', 'mybooking-wp-plugin' ) ?></span>
          </a>
          <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
            <span class="carousel-control-next-icon" aria-hidden="true"></span>
            <span class="sr-only">
              <? echo _x('Next', 'activity_detail', 'mybooking-wp-plugin' ) ?></span>
          </a>
        </div>
    ...
    <div class="col-md-4">
      ...
      <p class="mt-1 text-muted">
        <? echo _x('Please choose your dates in the availability calendar', 'activity_detail', 'mybooking-wp-plugin' ) ?>
        <hr>

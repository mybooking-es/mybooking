                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input class="form-control" id="zip" name="customer_address[zip]" type="text"
                            placeholder="<%=configuration.escapeHtml("<?php echo esc_html_x( 'Postal Code', 'activity_my_reservation', 'mybooking') ?>")%>"
                      ...
                      <h6 class="h6 border p-2 text-right bg-light">
                        <b><?php echo esc_html_x( 'Partipant', 'activity_my_reservation', 'mybooking' ) ?>
                          #<%=index%></b></h6>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_name]"
                            title="<?php echo esc_html_x( 'Name', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="text"
                            placeholder="<?php echo esc_html_x( 'Name', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_surname]"
                            title="<?php echo esc_html_x( 'Surname', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="text"
                            placeholder="<?php echo esc_html_x( 'Surname', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_document_id]"
                            title="<?php echo esc_html_x( 'Document ID', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="text"
                            placeholder="<?php echo esc_html_x( 'Document ID', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_date_of_birth]"
                            title="<?php echo esc_html_x( 'Date of birth', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="date"
                            placeholder="<?php echo esc_html_x( 'Date of birth', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_phone]"
                            title="<?php echo esc_html_x( 'Phone number', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="text"
                            placeholder="<?php echo esc_html_x( 'Phone number', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_email]"
                            title="<?php echo esc_html_x( 'E-mail', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="text"
                            placeholder="<?php echo esc_html_x( 'E-mail', 'activity_my_reservation', 'mybooking') ?>:"
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_height]"
                            title="<?php echo esc_html_x( 'Height (cm)', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="number"
                            placeholder="<?php echo esc_html_x( 'Height (cm)', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input name="order_item_customers[<%=index%>][customer_weight]"
                            title="<?php echo esc_html_x( 'Weight (kg)', 'activity_my_reservation', 'mybooking') ?>"
                            data-toggle="tooltip" class="form-control alt" type="number"
                            placeholder="<?php echo esc_html_x( 'Weight (kg)', 'activity_my_reservation', 'mybooking') ?>:"
                        ...
                        <div class="form-group col-md-4">
                          <div class="form-check">
                            <input name="order_item_customers[<%=index%>][customer_allergies]"
                              title="<?php echo esc_html_x( 'Allergies', 'activity_my_reservation', 'mybooking') ?>"
                              ...
                              title="<?php echo esc_html_x( 'Allergies detail', 'activity_my_reservation', 'mybooking') ?>"
                              data-toggle="tooltip" class="form-control alt" type="number"
                              placeholder="<?php echo esc_html_x( 'Allergies detail', 'activity_my_reservation', 'mybooking') ?>:"
                          ...
                          <div class="form-group col-md-4">
                            <div class="form-check">
                              <input name="order_item_customers[<%=index%>][customer_intolerances]"
                                title="<?php echo esc_html_x( 'Intolerances', 'activity_my_reservation', 'mybooking') ?>"
                                data-toggle="tooltip" class="form-check-input" type="checkbox"
                                ...
                                title="<?php echo esc_html_x( 'Intolerances detail', 'activity_my_reservation', 'mybooking') ?>"
                                data-toggle="tooltip" class="form-control alt" type="number"
                                placeholder="<?php echo esc_html_x( 'Intolerances detail', 'activity_my_reservation', 'mybooking') ?>:"
                            ...
                            <div class="form-group col-md-4">
                              <div class="form-check">
                                <input name="order_item_customers[<%=index%>][customer_slight_injuries]"
                                  title="<?php echo esc_html_x( 'Slight injuries', 'activity_my_reservation', 'mybooking') ?>"
                                  data-toggle="tooltip" class="form-check-input" type="checkbox"
                                  ...
                                  title="<?php echo esc_html_x( 'Slight injuries detail', 'activity_my_reservation', 'mybooking') ?>"
                                  data-toggle="tooltip" class="form-control alt" type="number"
                                  placeholder="<?php echo esc_html_x( 'Slight injuries detail', 'activity_my_reservation', 'mybooking') ?>:"
                              ...
                              <div class="form-group col-md-4">
                                <div class="form-check">
                                  <input name="order_item_customers[<%=index%>][customer_diseases]"
                                    title="<?php echo esc_html_x( 'Diseases', 'activity_my_reservation', 'mybooking') ?>"
                                    data-toggle="tooltip" class="form-check-input" type="checkbox"
                                    ...
                                    title="<?php echo esc_html_x( 'Diseases detail', 'activity_my_reservation', 'mybooking') ?>"
                                    data-toggle="tooltip" class="form-control alt" type="number"
                                    placeholder="<?php echo esc_html_x( 'Diseases detail', 'activity_my_reservation', 'mybooking') ?>:"
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select name="order_item_customers[<%=index%>][customer_experience_product_1]"
                                    ...
                                    <option value="0" <% if (order_item_customer.customer_experience_product_1 == '0'){%>selected<%}%>><?php echo esc_html_x( 'Never', 'activity_my_reservation', 'mybooking') ?></option>
                                                <option value="1" <% if (order_item_customer.customer_experience_product_1 == '1'){%>selected<%}%>><?php echo esc_html_x( 'Once', 'activity_my_reservation', 'mybooking') ?></option>
                                                <option value="2" <% if (order_item_customer.customer_experience_product_1 == '2'){%>selected<%}%>><?php echo esc_html_x( 'Twice', 'activity_my_reservation', 'mybooking') ?></option>
                                                <option value="3" <% if (order_item_customer.customer_experience_product_1 == '3'){%>selected<%}%>><?php echo esc_html_x( 'Three or more times', 'activity_my_reservation', 'mybooking') ?></option>                                         
                                              </select>
                                            </div>
                                            <% } %>

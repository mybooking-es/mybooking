...
<script type="text/tpml" id="script_variant_product_resume">
  <div style="display: flex; align-items: center; justify-content: space-between; margin: 0 -0.5rem;">
    <div style="margin-top: -5px;">
      <% for (var idxV=0;idxV<variantsSelected.length;idxV++) { %>
        <div style="display: inline-block; margin-right: 0.2rem; border-radius: 2px; border: 1px solid lightgray; font-size: 12px;"><span style="display: inline-block;  padding: 2px;"><%= variantsSelected[idxV]['quantity'] %></span> <span style="display: inline-block;  padding: 2px; background-color: lightgray;"><%= variantsSelected[idxV]['name'] %></span></div>
      <% } %>
    </div>

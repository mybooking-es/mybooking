  ...
  <form id="form-reservation" name="booking_information_form" autocomplete="off">
    ...
    <div class="form-row">
      <div class="form-group col-md-12">
        <button class="btn btn-outline-dark" id="btn_update_reservation" type="button"><?php _e('Actualizar', 'mybooking') ?></button>
      </div>
    </div>
  </form>
...
<script type="text/tmpl" id="script_payment_detail">
  ...
  <% if (booking.total_paid == 0) {%>
    <div id="payment_amount_container" class="alert alert-info">
      <%= i18next.t('complete.reservationForm.booking_amount', {amount:configuration.formatCurrency(booking.total_pending) }) %>
    </div>
  <% } %>

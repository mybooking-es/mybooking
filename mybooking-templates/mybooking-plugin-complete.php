            ...
            <form id="form-reservation" name="reservation_form">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="customer_name" name="customer_name" type="text" placeholder="<?php _e('Nombre', 'mybooking') ?>*">
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="flight_company" name="flight_company" type="text" placeholder="<?php _e('Compañia', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">

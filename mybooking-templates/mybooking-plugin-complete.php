              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="street" name="street" type="text"
                    placeholder="<?php _e('Calle', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  <label for="number"><?php _e('Número', 'mybooking') ?></label>
                  <input class="form-control" id="number" name="number" type="text"
                    placeholder="<?php _e('Número', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="complement" name="complement" type="text"
                    placeholder="<?php _e('Complemento (piso/puerta)', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="driver_surname" name="driver_surname" type="text"
                    placeholder="<?php _e('Apellidos del conductor', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="driver_document_id" name="driver_document_id" type="text"
                    placeholder="<?php _e('Nif o pasaporte del conductor', 'mybooking') ?>">
                </div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="driver_driving_license_number" name="driver_driving_license_number"
                    type="text" placeholder="<?php _e('Número del carnet de conducir', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  <label
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="flight_company" name="flight_company" type="text"
                    placeholder="<?php _e('Compañia', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="flight_number" name="flight_number" type="text"
                    placeholder="<?php _e('Número de vuelo', 'mybooking') ?>">
                </div>
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="flight_time" name="flight_time" type="text"
                    placeholder="<?php _e('Hora prevista', 'mybooking') ?>">
                </div>
              </div>
              <!-- Reservation : payment -->

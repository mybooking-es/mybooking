            ...
            <form id="form-reservation" name="reservation_form">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="name" name="customer_name" type="text" placeholder="<?php _e('Nombre', 'mybooking') ?>:*">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  <label for="confirm_email"><?php _e('Confirmar correo eléctronico', 'mybooking') ?></label>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="mobile_phone" name="customer_mobile_phone" id="customer_mobile_phone"
                    type="text" placeholder="<?php _e('Teléfono alternativo', 'mybooking') ?>:">
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control" id="Compañia" name="flight_company" type="text" placeholder="<?php _e('Compañia', 'mybooking') ?>:">
                </div>
                <div class="form-group col-md-6">

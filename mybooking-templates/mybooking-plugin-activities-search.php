<div class="jumbotron jumbotron-fluid">
  <div class="container-fluid">
    <form name="search_activities_form" class="form-horizontal" method="get"
      ...
      action="<?php echo esc_attr( $args['search_path'] )?>" <?php } ?>>
      <div class="row">
        <div class="col-md-12">
          <div class="form-row search_fields_container">
            <div class="form-group col-md-5">
              <input type="text" size="50" class="form-control"
                <?php if ( array_key_exists('q', $args) && $args['q'] != '') { ?>value="<?php echo esc_attr( $args['q'] )?>"
                <?php } ?> name="q" id="search_q"
                placeholder="<?php echo esc_html_x( 'Search', 'activities_search', 'mybooking' ) ?>">
            </div>
